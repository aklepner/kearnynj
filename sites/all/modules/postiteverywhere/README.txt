; $Id: README.txt,v 1.1.2.5 2010/09/19 05:56:27 confiz Exp $
...
2. Get facebook API key:
	...
	ii.	Add 'xmlns:fb="http://www.facebook.com/2008/fbml"' (quotes for clarity) 
		attribute in the HTML tag of your theme's page.tpl file to enable FBML on all 
		the pages of your drupal installation.
...
3. Get Twitter registered
	i.	Create an application on twitter https://twitter.com/apps/new
		-> Application website should be [YOUR Domain] e.g. 'www.example.com'
       (Twitter don't allow domain names like 'http://drupal6' or 'http://localhost' so make sure
...
4. LinkedIn
	...
	ii. Application type should be Web Application
	iii. Select an appropritate application type and use
	iv. Select live status as 'development' if it is under dev or live otherwise
...
Updater Contact: ghulam.mohayyuddin@gmail.com